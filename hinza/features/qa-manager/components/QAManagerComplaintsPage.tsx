      ...
      <div className="mb-6 flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-4 sm:flex-row sm:items-center">
        <div className="relative flex-1">
          <input
            ...
            className="w-full rounded-lg border border-gray-300 py-2 pl-10 pr-4 text-sm text-gray-900 placeholder:text-gray-500 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
          />
          <svg
        ...
        <select
          ...
          className="rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500"
        >
            ...
            <div className="space-y-6 p-6">
                ...
                <div className="rounded-lg border border-amber-200 bg-amber-50 p-4">
                  ...
                  <div className="flex items-center gap-3">
                    <select
                      ...
                      disabled={assigning}
                      className="flex-1 rounded-lg border border-gray-300 px-3 py-2 text-sm text-gray-900 focus:border-amber-500 focus:outline-none focus:ring-1 focus:ring-amber-500 disabled:opacity-50"
                    >
              ...
              <div>
                ...
                <div className="space-y-3 rounded-lg border border-gray-200 bg-gray-50 p-4">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm font-medium text-gray-700">SLA</p>
